...
bgImg = pygame.image.load(r"textures\background1.png")
butImg = pygame.image.load(r"textures\gbutton.png")
butCovImg = pygame.image.load(r"textures\buttoncover.png")
...
while True:
    ...
    screen.blit(bgImg, (0, 0))
    screen.blit(playerImg, (x, y))
    screen.blit(butImg, (boxx, boxy))
    screen.blit(butCovImg, (0, 300))
    pygame.display.flip()
    clock.tick(60)
